...
While geophysical tools have allowed us to probe active accretionary wedges, direct evidence of the conditions that promote coseismic slip can only be found by examining the plate boundary itself by turning to exhumed subduction terranes. In this work, I **document a previously undescribed exhumed seismogenic paleomegathrust interface in the Olympic Mountains, WA**—the first such example from the modern Cascadia subduction zone. Until this work, no geological investigations have been conducted west of Mt. Olympus since the 1970s.

• At Lake of the Gods, I document a previously undescribed steeply-dipping, pervasively sheared, high-strain mélange belt ~450 meters wide containing  nine major linear fault strands several meters wide each. These fault strands, topographically expressed as distinctive linear gullies, contain localized bands of fault gouge and discrete faults exhibiting numerous apparent individual principal slip surfaces. We argue that these rocks represent a **paleomegathrust interface hosted in the sediments**, shedding light on megathrust earthquake processes at clastic sediment rich subduction zones. The fault zone has many simultaneously active fault strands comprising a **webbed fault structure that itself is the décollement**. 

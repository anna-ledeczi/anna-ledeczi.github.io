...
- Watt, J.T, Ledeczi, <strong>A.M.</strong>, Lucas, M.C., and Tobin, H.J. Quaternary faults offshore the U.S. Cascadia subduction zone. USGS Data Release. DOI: 10.5066/P14HJMM9 (In review with USGS).
...
While geophysical tools have allowed us to probe active accretionary wedges, direct evidence of the conditions that promote coseismic slip can only be found by examining the plate boundary itself, such as through exhumed subduction terranes. In this work, I **documented a previously undescribed exhumed seismogenic paleomegathrust interface in the Olympic Mountains, WA**—the first such example from the modern Cascadia subduction zone. Until this work, no geological investigations have been conducted in the Olympic Core west of Mt. Olympus since the 1970s.

- At Lake of the Gods, we characterized a previously undescribed pervasively sheared high-strain mélange belt containing many major linear fault strands [Ledeczi et al. (2025)](https://pubs.geoscienceworld.org/gsa/gsabulletin/article/doi/10.1130/B38335.1/661921/Structure-and-properties-of-the-Cascadia-plate). These fault strands, topographically expressed as distinctive linear gullies, contain localized bands of fault gouge and discrete faults exhibiting numerous principal slip surfaces. We argue that these rocks represent a **paleomegathrust interface hosted in the sediments**, shedding light on megathrust earthquake processes at clastic-sediment rich subduction zones like Cascadia. The fault zone has many simultaneously active fault strands comprising a braided fault structure that itself is the décollement.

Related work: 
- <strong>Ledeczi, A.M.</strong>, Tobin, H.J., Chen, T., and Mulcahy, S., and Condit, C. (2025). Structure and properties of the Cascadia plate interface: Evidence from a newly described exhumed paleomegathrust in the Olympic Subduction Complex. GSA Bulletin. DOI: [10.1130/B38335.1](https://pubs.geoscienceworld.org/gsa/gsabulletin/article/doi/10.1130/B38335.1/661921/Structure-and-properties-of-the-Cascadia-plate)
- <strong>Ledeczi, A.M.<strong>, Tobin, H.J., Condit, C.B., Chen, T-W., Lindquist, P.C., García-Lasanta, C., Housen, B., and Mulcahy, S.R. Pressure solution accommodates negligible volume loss in the subduction seismogenic zone. (In review at EPSL). 
  
  <div style="text-align: center;">
    <img src="/assets/img/IMG_31202.jpeg" alt="Harold Tobin and Anna Ledeczi with the south face of Mt. Tom and Mt. Olympus." style="width: 100%; height: auto;" />
    <p>Harold Tobin and Anna Ledeczi with the south face of Mt. Tom and Mt. Olympus.</p>
  </div>

  ### Other projects
- <strong>Ledeczi, A.M.</strong>, Ekström, G., & Taylor, B. (2025). Earthquake relocations illuminate tectonics along the Bismarck Sea Seismic Lineation, Papua New Guinea. Seismica, 4(2). DOI: [10.26443/seismica.v4i2.2041](https://seismica.library.mcgill.ca/article/view/2041)
